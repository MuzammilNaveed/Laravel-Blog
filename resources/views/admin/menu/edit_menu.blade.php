    ...
    <div class="container-fluid p-0">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                @if($id)
                <a href="{{url('menu-item')}}/{{$id}}" style="float:right" class="btn btn-primary mb-3">Add Menu Items</a>
                ...
                <div class="card p-3">
                        ...
                        <ol class="dd-list">
                            ...
                            <li class="dd-item" data-id="{{$item->id}}" data-position="{{$item->id}}">
                                <div class="menu-item-actions">
                                    <a href="{{url('edit-menu-item')}}/{{$item->id}}/{{$id}}"> <i class="fas fa-pencil-alt ml-1"></i> </a>
                                    <i class="fas fa-times ml-2" onclick="deleteMenuItem({{$item->id}})"></i>
                                </div>
                    ...
                    <button type="button" class="btn btn-primary btn-cons btn-lg mt-2 saveMenuPosition">Save</button>
                </div>
            ...
            <div class="col-md-6">
                <div class="card p-3">
                    <form action="{{url('update-menu')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group form-group-default">
                            <label> Name</label>
                            <input name="name" value="{{$menu->name}}" type="text" class="form-control" placeholder="Menu Name" required>
                        </div>
