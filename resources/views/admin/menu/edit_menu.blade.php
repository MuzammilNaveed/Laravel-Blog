...
.dd { position: relative; display: block; margin: 0; padding: 0; width:100% !important; max-width: 600px; list-style: none; font-size: 13px; line-height: 20px; }
...
$(document).ready(function() {
    ...
    function sortMenuItems(values,menu_id) {
        ...
        $.ajax({
            ...
            data: { data: values , menu_id:menu_id},
            dataType: "json",
